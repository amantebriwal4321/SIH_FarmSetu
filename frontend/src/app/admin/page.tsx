...
export default async function Page() {
  ...
  const live = await getLivePrices("Tomato");
  ...
  return <AdminConsole overview={overview} crops={crops} units={UNITS} details={details} qrBase={qrBase} isLan={isLan} live={live} />;
}
